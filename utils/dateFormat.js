/**
 * Function to format a Date type object to a custom format string
 * @param mask the pattern to format the date with
 * @returns {XML|string|void} the formatted date
 */
